# CLASS DEFINITIONS FOR NEURAL NETWORKS USED IN DEEP LEARNING METHOD
...
class DeepNet(tf.keras.Model):
    ...
    def __init__(self, layer_width, n_layers, input_dim, final_trans=None,active = "tanh"):
        ...
        self.initial_layer = DenseLayer(layer_width, input_dim, transformation = active)
...
class DeepNet_DDM(tf.keras.Model):
    def __init__(self, layer_width, n_layers, input_dim, final_trans = None, k = 2, active = "tanh"):
        ...
        self.initial_layer = DenseLayer(layer_width, input_dim, transformation = self.active)
